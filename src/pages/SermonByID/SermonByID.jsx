      ...
      <div className="wrapper" >
        <div className="content-block">
          <div className="iframe-block">
            <iframe
              title="sadf"
              className="iframe-block__you-tube"
          ...
          <div className="sermon-title">Воспитательная сила Благодати</div>
          <div className="sermon-description">
            Возможно, мысль об обретении Божьей благодати для вас нова, и вы не
            совсем понимаете, о чем я веду речь. Мы приобретаем ту силу, которую
            Бог приготовил нам во Христе. Можно использовать такую аналогию: мы
            берем деньги с неиссякаемого банковского счета - со счета благодати
          ...
          <div className="sound-cloud-block">
            <svg
              width="246"
              height="28"
              viewBox="0 0 246 28"
          ...
          <div className="author-block">
            <div className="author-block__avatar"></div>
            <div className="author-block__name">Андрей Резуненко</div>
          </div>

          <div className="nav-block">
            <div className="nav-block__page page--prev">
              <svg
                width="13"
                height="20"
                viewBox="0 0 13 20"
              ...
              <span className="title">Предыдущая</span>
            </div>
            <div className="nav-block__page page--next">
              <span className="title">Следующая</span>
              <svg
                width="13"
                height="20"
                viewBox="0 0 13 20"
        ...
        <div className="similar-sermons-block">
          <div className="similar-sermons-block__title">Похожие проповеди</div>

          <div className="sermons-list">
            <div className="sermons-list-item">
              <img
          ...
          <div className="return-to-sermons-list">
            <span className="title">К списку проповедей</span>
          </div>
        </div>
      </div>
    </div>
